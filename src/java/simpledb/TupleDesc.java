...
public class TupleDesc implements Serializable {
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        // some code goes here
    	Type[] newTypeArr = new Type[td1.numFields() + td2.numFields()];
    	String[] newFieldArr = new String[td1.numFields() + td2.numFields()];
    	for(int i = 0; i < td1.numFields(); i++)
    	{
    		newTypeArr[i] = td1.getFieldType(i);
    		newFieldArr[i] = td1.getFieldName(i);
    	}
    	for(int i = 0; i < td2.numFields(); i++)
    	{
    		newTypeArr[i + td1.numFields()] = td2.getFieldType(i);
    		newFieldArr[i + td1.numFields()] = td2.getFieldName(i);
    	}
    ...
    public int hashCode() {
    	...
    	int result = 0;
        for (TDItem item : tdItems) {
            result += item.fieldType.hashCode();
        }
        return result;
